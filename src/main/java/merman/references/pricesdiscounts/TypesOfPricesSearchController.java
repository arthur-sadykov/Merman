 ...
 */
public class TypesOfPricesSearchController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        optionsMap.put("Валюта цены", new SimpleBooleanProperty(false));
        ...
        textColumnNameMap.put("Валюта цены", CURRENCY);
    ...
    private void handleBtnSearchPress(ActionEvent event) {
        ...
        List<TypesOfPrices> contractorTypes = typesOfPricesDAO.find(searchString, columnNames);
        tvTypesOfPrices.getItems().setAll(contractorTypes);
    }
}
